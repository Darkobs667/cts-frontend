...
const LoginCTS = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white p-4 font-sans text-slate-800">
      ...
      <div className="card w-full max-w-md bg-white shadow-[0_20px_50px_rgba(0,0,0,0.08)] rounded-3xl p-10 border border-slate-50">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="form-control w-full">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="input w-full h-14 pl-12 bg-slate-50 border-none focus:ring-2 focus:ring-emerald-400 rounded-2xl text-slate-700 placeholder:text-slate-300 transition-all font-medium"
                required
              />
            </div>
            {errors.identifiant && <span className="text-red-400 text-[10px] font-bold mt-1 ml-2">{errors.identifiant}</span>}
          </div>
          ...
          <div className="form-control w-full">
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="••••••••••••"
                className="input w-full h-14 pl-12 bg-slate-50 border-none focus:ring-2 focus:ring-emerald-400 rounded-2xl text-slate-700 placeholder:text-slate-300 transition-all"
                required
              />
              <button
                type="button"
          ...
          <button
            ...
            className={`btn w-full h-14 ${loading ? 'bg-slate-200' : 'bg-[#00d991] hover:bg-[#00c282]'} border-none text-slate-900 font-bold normal-case rounded-2xl gap-3 shadow-lg flex items-center justify-center shadow-emerald-100 mt-4 transition-all`}
            type="submit"
          >
            {loading ? (
      ...
      <div className="mt-12 flex items-center gap-2 text-[10px] font-black text-emerald-500 bg-emerald-50/50 px-4 py-2 rounded-full border border-emerald-100">
        <ShieldCheck size={14} />
